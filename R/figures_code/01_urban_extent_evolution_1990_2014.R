...
png(here::here("figures", "figura_1_urban_extent_evolution.png"),
...
# pdf(here::here("figures", "urban_extent_evolution.pdf"),
#     width = 16, height = 11,
# )
#
# gg_final +
...
ggsave(filename = here::here("figures", "figura_1_urban_extent_evolution.pdf"),
       width = 16, height = 11, units = "cm", dpi = 300, scale = 1)
