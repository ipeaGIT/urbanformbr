...
body <- "https://www.gov.br/infraestrutura"
link <- "https://www.gov.br/infraestrutura/pt-br/assuntos/transito/conteudo-denatran/estatisticas-frota-de-veiculos-denatran"
...
lapply(seq_along(temp_zip), function(i){  # i = 1
...
link2020 <- "/pt-br/assuntos/transito/conteudo-denatran/frota-de-veiculos-2020"
html2020 <- paste(readLines(paste0(body,link2020)), collapse="\n")
temp_2020 <- stringr::str_match_all(html2020, "<a href=\"(.*?)\" style")[[1]][,2]


temp_2020 <- stringr::str_match_all(html2020, "<a href=\"(.*?)\"")
temp_2020 <- unlist(temp_2020)
temp_2020 <- temp_2020[temp_2020 %like% ".xls" |
                         temp_2020 %like% ".zip"] #
temp_2020 <- temp_2020[!(temp_2020 %like% "a href")]
temp_2020
# only january
